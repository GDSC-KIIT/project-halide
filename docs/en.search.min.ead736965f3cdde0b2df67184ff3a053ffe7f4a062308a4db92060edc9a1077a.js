...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/project-halide-website/flexsearch.min.js');loadScript('/project-halide-website/en.search-data.min.3a5f58d32b56318d02c59cd45cb48950656b3d3e808ce5699b3832a5cdb8f8f8.js',function(){input.required=false;search();});}
