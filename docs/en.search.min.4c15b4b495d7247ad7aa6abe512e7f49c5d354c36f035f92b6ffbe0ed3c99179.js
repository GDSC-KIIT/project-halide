...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/project-halide/flexsearch.min.js');loadScript('/project-halide/en.search-data.min.5a3b1ebbb8289d3638b8497aff5d569e597331349daa64d58f79d92edd64d223.js',function(){input.required=false;search();});}
