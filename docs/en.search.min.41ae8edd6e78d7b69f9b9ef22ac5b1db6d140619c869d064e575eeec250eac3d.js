...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/project-halide-website/flexsearch.min.js');loadScript('/project-halide-website/en.search-data.min.f89d952122454d9ac7b84c335800072b9afdcd4117bfb7276853f93891d32b38.js',function(){input.required=false;search();});}
