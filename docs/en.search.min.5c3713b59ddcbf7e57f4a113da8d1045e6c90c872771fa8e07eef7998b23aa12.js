...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/project-halide-website/flexsearch.min.js');loadScript('/project-halide-website/en.search-data.min.ffb05ddfcf8cea22cd5bc651eb657b0316734d8451ce5feefc3e442c76f310c4.js',function(){input.required=false;search();});}
