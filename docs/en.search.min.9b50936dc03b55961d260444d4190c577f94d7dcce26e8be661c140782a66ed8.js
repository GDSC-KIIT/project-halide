...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/project-halide-website/flexsearch.min.js');loadScript('/project-halide-website/en.search-data.min.dcddd0b6a54e26550edb647ff26e333e078d34bf7f1ba667ccd12c7b31d3d6cc.js',function(){input.required=false;search();});}
