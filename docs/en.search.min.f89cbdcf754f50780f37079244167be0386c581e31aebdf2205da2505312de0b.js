...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e29af0121490ef64bd9ddaf4b6ab4612a740fc8a2d6630421c221037a7008440.js',function(){input.required=false;search();});}
