...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/project-halide/flexsearch.min.js');loadScript('/project-halide/en.search-data.min.ef48a4c28ce4b6c603ec45783b05bd1820d0a47f5b847dd71ac6608715524a9f.js',function(){input.required=false;search();});}
