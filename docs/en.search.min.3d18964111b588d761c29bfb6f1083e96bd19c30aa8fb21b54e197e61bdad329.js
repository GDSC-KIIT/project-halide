...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/project-halide/flexsearch.min.js');loadScript('/project-halide/en.search-data.min.803a65c03cb48aa952ead48325958ae43de6242ac2ffadd2e86615161f26f0c1.js',function(){input.required=false;search();});}
