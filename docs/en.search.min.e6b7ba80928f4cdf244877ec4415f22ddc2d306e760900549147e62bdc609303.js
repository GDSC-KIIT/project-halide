...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/project-halide-website/flexsearch.min.js');loadScript('/project-halide-website/en.search-data.min.3ecb216362853ee8d5adc0829cdeeee8f4e480e48be4ed3644f35bd8089ac317.js',function(){input.required=false;search();});}
