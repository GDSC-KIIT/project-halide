...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/project-halide-website/flexsearch.min.js');loadScript('/project-halide-website/en.search-data.min.6f723e0d137187af6e70fdf8b58ce6c2d508b684164a6832fb0e85aecd217d9b.js',function(){input.required=false;search();});}
