...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/project-halide-website/flexsearch.min.js');loadScript('/project-halide-website/en.search-data.min.347e79bb9ac61c5083c5a29842b39f2d3dd0adab7309a5546d1d7c9e532b183f.js',function(){input.required=false;search();});}
