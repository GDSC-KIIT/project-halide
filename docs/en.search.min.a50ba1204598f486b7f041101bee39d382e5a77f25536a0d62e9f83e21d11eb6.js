...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/project-halide/flexsearch.min.js');loadScript('/project-halide/en.search-data.min.2549ec3a09ef869db81b480f78addce7ffba447c7c5fe55206116b148a5c0ec9.js',function(){input.required=false;search();});}
