...
gcc -c -I../include/ -ffreestanding -fno-stack-protector -m32 -Iinclude -nostdlib -fno-builtin -fno-exceptions -fno-leading-underscore -Wno-write-strings vtty.c -o vtty.o
gcc -c -I../include/ -ffreestanding -fno-stack-protector -m32 -Iinclude -nostdlib -fno-builtin -fno-exceptions -fno-leading-underscore -Wno-write-strings text.c -o text.o
